...
let tyrannosaurus = { name: "tyrannosaurus", diet: "carnivorous", weight: "7000kg", length: "12m", period: "Late Cretaceous", roar: function roar() { return "RAWERSRARARWERSARARARRRR!" } };
...
for (let i = 0; i < graduates.length; i++) {
  var object = graduates[i];
  contactInfo[i] = object.first_name + ' ' + object.email;
}
